package ca.ulaval.glo4003.projet.base.ws.application.context;
...
import ca.ulaval.glo4003.projet.base.ws.infrastructure.communication.CommunicationSmtpServer;
...
public class DevApplicationContext extends ApplicationContext {
  ...
  private void registerServiceLocator() {
    ...
    //MessageSender
    ServiceLocator.getInstance().register(CommuncationTechnic.class, new CommunicationSmtpServer());
